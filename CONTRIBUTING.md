...
Hi there! We're thrilled that you'd like to contribute to Grove. Contributions to this project are [released](https://help.github.com/articles/github-terms-of-service/#6-contributions-under-repository-license) to the public under the [project's open source license](LICENSE).
...
## AI contributions in Grove

> [!IMPORTANT]
>
> If you are using **any kind of AI assistance** to contribute to Grove,
> it must be disclosed in the pull request or issue.

We welcome and encourage the use of AI tools to help improve Grove! Many valuable contributions have been enhanced with AI assistance for code generation, issue detection, and feature definition.

That being said, if you are using any kind of AI assistance (e.g., agents, ChatGPT) while contributing to Grove,
...
- **Clear rationale** - You can explain why the change is needed and how it fits within Grove's goals
...
- Generic suggestions that don't address specific Grove needs
